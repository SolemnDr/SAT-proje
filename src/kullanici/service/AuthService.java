...
public class AuthService {
    ...
    public enum AuthResult { SUCCESS, WRONG_PASSWORD, USER_NOT_FOUND, USERNAME_TAKEN, EMAIL_TAKEN, WEAK_PASSWORD }

    public AuthResult register(String username, String email, String password, int role) {
        if (password == null || password.trim().length() < 6) return AuthResult.WEAK_PASSWORD;
        try {
            ...
            u.setRole(role); // Rolü set ediyoruz
